...
![image.png](./锁.assert/1747623540902-02b0ec66-3805-4a83-bfbd-df8fb6e7e35c.png)
...
![image.png](./锁.assert/1747623540681-aeb77a6a-c185-4841-82d3-2b64301a2913.png)
...
![image.png](./锁.assert/1747623540783-7e09a2e9-2420-468d-8e55-66e35921ba2a.png)


③、**Next-key Lock 临键锁**
临键指的是间隙加上它右边的记录组成的**左开右闭区间**。比如上述的`(1,6]、(6,8]`等。
![image.png](./锁.assert/1747623540979-ba2d7f6a-76e8-44d4-8ba5-0d92e3c1f45b.png)
...
![image.png](./锁.assert/1747623540757-6440a006-7ad1-40de-9571-274733b9bf59.png)
...
- (12, +∞)：在最大记录之后的间隙。![image.png](./锁.assert/1747623540988-4e9f0b0c-f57e-4c9c-bd3e-55ab7ab466d2.png)
...
![image.png](./锁.assert/1747623541507-fbe3f6d2-08ba-46d1-aa91-485f0d634057.png)
...
![image.png](./锁.assert/1747623541273-a57b9570-53c6-42bb-bef2-96cf157469af.png)
...
![image.png](./锁.assert/1747623541637-6dcb9a74-14b8-4b7e-ab67-9c9db3476874.png)

解决方法：
第一步，使用 `SHOW ENGINE INNODB STATUS\G;` 查看死锁信息。
![image.png](./锁.assert/1747623541841-c141d6f3-0d94-4235-8212-3c53e16c36ac.png)
...
![image.png](./锁.assert/1747623541363-eb8ea40c-d80c-423a-8bff-01707b979ef1.png)
