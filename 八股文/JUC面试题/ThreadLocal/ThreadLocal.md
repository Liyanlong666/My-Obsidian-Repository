...
![image.jpg](./ThreadLocal.assert/1738590534501-88020dbc-5d5c-4bce-a715-e70fcf4e824c.png)
...
有用到过，用来存储用户信息。
![image.jpg](./ThreadLocal.assert/1738590535438-5d24776d-fbda-466a-beb2-a617d6e7a565.png)
...
![image.jpg](./ThreadLocal.assert/1738590537279-a17ce8ca-fe5d-498b-b654-e2bff0b9c879.png)

技术派实战源码
这样我们在任何一个地方，都可以取出 ThreadLocal 中存的用户信息。
![image.jpg](./ThreadLocal.assert/1738590536116-4023879e-26f0-4703-8391-ac34553e3a9b.png)

技术派实战源码
很多其它场景的 cookie、session 等等数据隔离都可以通过 ThreadLocal 去实现。
![image.jpg](./ThreadLocal.assert/1738590535374-007ad01d-c4e0-4854-9205-1a7b2854d4ea.png)
...
![image.jpg](./ThreadLocal.assert/1738590536234-ecd374d8-d5cb-47c9-b8cb-61f029747068.png)

二哥的 Java 进阶之路：ThreadLocalMap
ThreadLocalMap 是 ThreadLocal 的静态内部类，它内部维护了一个 Entry 数组，key 是 ThreadLocal 对象，value 是线程的局部变量本身。
![image.jpg](./ThreadLocal.assert/1738590535820-bfce1b58-dd32-487a-b3f0-2b4d604a35c4.png)

三分恶面渣逆袭：ThreadLoca结构图
早期的 ThreadLocal 不是这样的，它的 ThreadLocalMap 中使用 Thread 作为 key，这也是最简单的实现方式。
![image.jpg](./ThreadLocal.assert/1738590536900-7e231d14-80a0-4c73-a7bf-9899cea216e2.png)
...
![image.jpg](./ThreadLocal.assert/1738590536304-0b798980-e269-4bff-849e-f7d3e4d32469.png)
...
![image.jpg](./ThreadLocal.assert/1738590536377-1f168658-45a9-4efd-90e2-01a37a84bbf8.png)
...
![image.jpg](./ThreadLocal.assert/1738590536743-0b627d2a-6829-4d0f-816f-39f2dea32984.png)
...
![image.jpg](./ThreadLocal.assert/1738590536839-7fde6ebd-721d-4194-9bb1-132825481350.png)
...
![image.jpg](./ThreadLocal.assert/1738590537519-71f6cc5f-b717-4be5-9e45-87ca49f5b837.png)
...
![image.jpg](./ThreadLocal.assert/1738590537370-fcc4e109-4a33-4e43-a862-549860a76422.png)
...
![image.jpg](./ThreadLocal.assert/1738590537155-915c8113-f21a-4d8b-a258-3230b7862265.png)
...
![image.jpg](./ThreadLocal.assert/1738590537490-1799d4f1-8122-4ada-a32f-e911e3d44d8d.png)

ThreadLocalMap扩容
具体代码：
![image.jpg](./ThreadLocal.assert/1738590537486-d7c00499-d8f5-483f-b4d2-55bb39f2df00.png)
